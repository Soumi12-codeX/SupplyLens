    ...
    <div className="h-screen flex bg-brand-dark overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 relative">
          ...
          {/* Compass Indicator */}
          <div className="absolute top-4 left-4 z-[1000] p-3 rounded-xl bg-slate-900/90 border border-white/10 backdrop-blur-md">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-neon-blue/10 border border-neon-blue/20 flex items-center justify-center">
                <Compass size={20} className="text-neon-blue" />
              </div>
              <div>
                <p className="text-white text-sm font-semibold">{truck.speed} km/h</p>
                <p className="text-slate-500 text-[10px]">Current Speed</p>
              </div>
            </div>
          </div>

          {/* Next Turn Banner */}
          <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[1000] px-5 py-3 rounded-xl bg-neon-blue/15 border border-neon-blue/30 backdrop-blur-md">
            <div className="flex items-center gap-3">
              <ArrowUp size={20} className="text-neon-blue" />
              <div>
                <p className="text-white text-sm font-semibold">Continue straight</p>
                <p className="text-neon-blue text-xs">12.4 km ahead</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Navigation Panel */}
        <div className="w-96 border-l border-white/5 bg-slate-950/80 backdrop-blur-md flex flex-col overflow-hidden">
          {/* Route Header */}
